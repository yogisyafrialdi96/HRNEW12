@teleport('body')
    ...
    }" x-init="init()" x-show="open" x-transition.opacity
        ...
        <div class="bg-white p-6 rounded-lg shadow-xl w-full max-w-sm text-center relative overflow-hidden transition-all duration-300"
            ...
            <div x-show="success" x-transition.opacity>
                <div class="relative w-16 h-16 mx-auto mb-4">
                    <div class="absolute inset-0 rounded-full border-4 border-green-500 border-t-transparent animate-spin"
                        x-show="!showCheck"></div>
                    <div x-show="showCheck" x-transition.opacity
                        class="absolute inset-0 w-16 h-16 bg-green-500 rounded-full flex items-center justify-center">
            ...
            <div x-show="!success" x-transition.opacity>
                ...
                <p class="text-sm text-gray-600 mb-6">Apakah Anda yakin ingin menghapus data ini? Tindakan ini tidak dapat
                    dibatalkan.</p>

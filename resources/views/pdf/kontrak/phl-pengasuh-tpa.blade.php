...
<head>
    ...
    <title>PHL PENGASUH TPA - {{ $kontrak->nomor_kontrak }}</title>
    <style>
        @page {
            margin-left: 2cm;
            margin-right: 2cm;
...
<body>
    ...
    <div class="content">
        ...
        <div class="pasal">
            Pihak Pertama memakai jasa Pihak Kedua sebagai {{ $kontrak->jabatan->nama_jabatan ?? '[Jabatan]' }} Al-Ittihad terhitung {{ \Carbon\Carbon::parse($kontrak->tglmulai_kontrak)->format('d F Y') }} sampai dengan {{ \Carbon\Carbon::parse($kontrak->tglselesai_kontrak)->format('d F Y') }}, dengan hari kerja Senin sd. Jum’at dengan jam kerja disesuaikan kebutuhan Unit dengan akumulasi total jam kerja 40 jam seminggu.
        </div>
        ...
        <div class="pasal">
            ...
            <ol type="a">
                ...
                <li>Honor lembur diberikan sesuai dengan aturan yang berlaku.</li>
                <li>Makan siang dan snack selama hari kerja (Senin s/d Jumat).</li>
                <li>Tunjangan BPJS Kesehatan Mandiri untuk Kelas III Rp. 35.000,- (Tiga puluh lima ribu rupiah) per bulan.</li>
                <li>THR diberikan sesuai dengan aturan yang berlaku.</li>

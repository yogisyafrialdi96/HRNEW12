...
<head>
    ...
    <title>SURAT KEPUTUSAN TETAP - {{ $kontrak->nomor_kontrak }}</title>
    <style>
        @page {
            margin-left: 2cm;
            margin-right: 2cm;
...
<body>
    ...
    <div class="content">
        ...
        <div class="pasal">
            Pihak Pertama memakai jasa Pihak Kedua sebagai {{ $kontrak->jabatan->nama_jabatan ?? '[Jabatan]' }} Al-Ittihad terhitung {{ \Carbon\Carbon::parse($kontrak->tglmulai_kontrak)->format('d F Y') }} sampai dengan {{ \Carbon\Carbon::parse($kontrak->tglselesai_kontrak)->format('d F Y') }}, dengan hari kerja Senin sd. Jum’at pukul 06.30 – 15.00 WIB.
        </div>
        ...
        <div class="pasal">
            ...
            <ol type="a">
                ...
                <li>Makan siang selama hari kerja (Senin s/d Jumat).

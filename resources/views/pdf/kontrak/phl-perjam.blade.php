...
<head>
    ...
    <title>Perjanjian Kerja PHL - {{ $kontrak->nomor_kontrak }}</title>
    <style>
        @page {
            /* margin: 2cm; */
            margin-left: 2cm;
...
<body>
    <div class="header">
        ...
        <h1>PERJANJIAN KERJA PEKERJA HARIAN LEPAS</h1>
    ...
    <div class="content">
        ...
        <ul style="margin: 5px 0;">
            <li>Menerima upah sesuai kesepakatan</li>
            <li>Perlindungan keselamatan kerja</li>
            <li>Perlakuan adil dan tanpa diskriminasi</li>
        </ul>

        <p style="margin: 5px 0;"><strong>Kewajiban Pekerja:</strong></p>
        <ul style="margin: 5px 0;">
            <li>Melaksanakan pekerjaan dengan baik dan bertanggung jawab</li>
            <li>Mematuhi peraturan dan tata tertib</li>
            <li>Hadir tepat waktu</li>
            <li>Menjaga kerahasiaan dan aset perusahaan</li>
        </ul>

        <div class="section-title">6. PEMUTUSAN HUBUNGAN KERJA</div>
        <ul>
            <li>Perjanjian berakhir pada tanggal yang telah ditetapkan atau sesuai kebutuhan</li>
            <li>Salah satu pihak dapat mengakhiri dengan pemberitahuan tertulis 14 hari sebelumnya</li>
            <li>Pekerja harus mengembalikan semua aset perusahaan</li>
        </ul>

        @if($kontrak->catatan)
        <div class="section-title">7. CATATAN</div>
        <p>{{ $kontrak->catatan }}</p>
        @endif

        <p style="margin-top: 12px; text-align: justify;">
            Demikian perjanjian ini dibuat dengan sebenarnya dalam keadaan sadar dan tanpa paksaan, 
    ...
    <div class="footer">
        <p style="margin: 3px 0;">Perjanjian Kerja Pekerja Harian Lepas</p>

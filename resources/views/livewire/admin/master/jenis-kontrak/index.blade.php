<div>
    <flux:heading size="xl">Master Kontrak</flux:heading>
    <flux:text class="mt-2">This Page Show List of master kontraks</flux:text>

    <div class="relative overflow-x-auto bg-white rounded-lg shadow-md p-6 mb-4 mt-4">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div class="flex flex-col md:flex-row gap-4 flex-1">
                <div class="flex-1">
                    <input wire:model.live="search" type="text" placeholder="Search Kontrak..."
                ...
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100"
                            wire:click="sortBy('nama_kontrak')">
                            <div class="flex items-center gap-2">
                                <span>Kontrak</span>
                                <div class="sort-icon">
                                    @if ($sortField === 'nama_kontrak')
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                @if ($showDeleted)
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <button wire:click="confirmForceDelete({{ $jeniskontrak->id }})"
                                ...
                                @else
                                    <div class="flex justify-center gap-2">
                                        <button wire:click="edit({{ $jeniskontrak->id }})"
                                        ...
                                        <button wire:click="confirmDelete({{ $jeniskontrak->id }})"
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-12 text-center text-gray-500">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-lg font-medium">No Master Kontrak found</p>
                                    <p class="text-sm">Get started by creating a new Master Kontrak.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
                    ...
                    <div class="px-6 py-5 border-b border-gray-100 bg-gray-50/50">
                        <div class="flex items-center justify-between">
                            <h3 class="text-xl font-semibold text-gray-900">
                                {{ $isEdit ? 'Edit Master Kontrak' : 'Create Master Kontrak' }}
                            </h3>
                    ...
                    <div class="px-6 py-6">
                        <form wire:submit.prevent="save" class="space-y-5">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input wire:model.live="nama_kontrak" type="text" placeholder="Enter Nama/Jenis Kontrak"
                            ...
                            <div class="space-y-2">
                                ...
                                <textarea wire:model="deskripsi" rows="3" placeholder="Deskripsi Kontrak..."
                        ...
                        <div class="flex gap-3 justify-end">
                            ...
                            <button type="submit" wire:click="save"
                                ...
                                <span wire:loading.remove wire:target="save">
                                    {{ $isEdit ? 'Update Kontrak' : 'Create Kontrak' }}
                                </span>

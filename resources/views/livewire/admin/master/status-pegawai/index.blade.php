<div>
    <flux:heading size="xl">Status Pegawai</flux:heading>
    <flux:text class="mt-2">This Page Show List of Status Pegawais</flux:text>

    <div class="relative overflow-x-auto bg-white rounded-lg shadow-md p-6 mb-4 mt-4">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div class="flex flex-col md:flex-row gap-4 flex-1">
                <div class="flex-1">
                    <input wire:model.live="search" type="text" placeholder="Search Status Pegawai..."
                ...
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider cursor-pointer hover:bg-gray-100"
                            wire:click="sortBy('nama_status')">
                            <div class="flex items-center gap-2">
                                <span>Status Pegawai</span>
                                <div class="sort-icon">
                                    @if ($sortField === 'nama_status')
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                @if ($showDeleted)
                                    <div class="flex justify-center gap-2">
                                        ...
                                        <button wire:click="confirmForceDelete({{ $statusPegawai->id }})"
                                ...
                                @else
                                    <div class="flex justify-center gap-2">
                                        <button wire:click="edit({{ $statusPegawai->id }})"
                                        ...
                                        <button wire:click="confirmDelete({{ $statusPegawai->id }})"
                        ...
                        <tr>
                            <td colspan="5" class="px-6 py-12 text-center text-gray-500">
                                <div class="flex flex-col items-center">
                                    ...
                                    <p class="text-lg font-medium">No Status Pegawai found</p>
                                    <p class="text-sm">Get started by creating a new Status Pegawai.</p>
                                </div>
                            </td>
                        </tr>
                    @endforelse
                    ...
                    <div class="px-6 py-5 border-b border-gray-100 bg-gray-50/50">
                        <div class="flex items-center justify-between">
                            <h3 class="text-xl font-semibold text-gray-900">
                                {{ $isEdit ? 'Edit Status Pegawai' : 'Create Status Pegawai' }}
                            </h3>
                    ...
                    <div class="px-6 py-6">
                        <form wire:submit.prevent="save" class="space-y-5">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <input wire:model.live="nama_status" type="text" placeholder="Enter Nama Status Pegawai"
                                        class="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all capitalize placeholder:normal-case">
                                    @error('nama_status')
                            ...
                            <div class="space-y-2">
                                ...
                                <textarea wire:model="deskripsi" rows="3" placeholder="deskripsi Status Pegawai..."
                        ...
                        <div class="flex gap-3 justify-end">
                            ...
                            <button type="submit" wire:click="save"
                                ...
                                <span wire:loading.remove wire:target="save">
                                    {{ $isEdit ? 'Update Status Pegawai' : 'Create Status Pegawai' }}
                                </span>

                        ...
                        <td class="px-6 py-4 text-right text-sm">
                            <div class="flex gap-2 justify-end">
                                ...
                                @if($item->status === 'draft')
                                    ...
                                    <button wire:click="submit({{ $item->id }})" class="text-green-600 hover:text-green-800">Submit</button>
                                @endif
        ...
        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full mx-4">
                ...
                <div class="p-6 space-y-4 max-h-96 overflow-y-auto">
                    <!-- Unit Approval Setting -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Unit & Template Approval</label>
                        <select wire:model.live="unit_approval_setting_id" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white">
                            <option value="">-- Pilih Unit --</option>
                            @foreach($this->unitApprovalSettings as $setting)
                                <option value="{{ $setting->id }}">{{ $setting->unit->unit ?? '-' }} ({{ $setting->template->nama_template ?? '-' }})</option>
                            @endforeach
                        </select>
                        @error('unit_approval_setting_id')
                    ...
                    <div>
                        ...
                        <select wire:model.live="izin_alasan_id" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <div>
                                ...
                                <input type="date" wire:model="tanggal_mulai" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white">
                            </div>
                            <div>
                                <label class="block text-xs text-gray-600 dark:text-gray-400 mb-1">Tanggal Selesai</label>
                                <input type="date" wire:model="tanggal_selesai" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white">
                            </div>
                        </div>
                        @error('tanggal_mulai')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    ...
                    <div>
                        ...
                        <input type="number" wire:model="jumlah_jam" min="1" max="8" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white" placeholder="Kosongkan jika sepanjang hari">
                        @error('jumlah_jam')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea wire:model="alasan" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white" rows="3"></textarea>
                        @error('alasan')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    @if($this->selectedAlasan?->perlu_surat_dokter)
                        <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 space-y-4 border border-blue-200 dark:border-blue-800">
                            ...
                            <div>
                                ...
                                <input type="date" wire:model="tanggal_surat_dokter" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white">
                            ...
                            <div>
                                ...
                                <input type="file" wire:model="file_surat_dokter" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white">
                ...
                <div class="flex gap-3 p-6 border-t border-gray-200 dark:border-gray-700 justify-end">
                    <button wire:click="closeModal" class="px-4 py-2 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-white rounded-lg hover:bg-gray-300">
                        Batal
                    </button>

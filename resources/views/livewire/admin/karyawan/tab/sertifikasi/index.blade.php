<div>
    ...
    <div class="flex flex-column sm:flex-row flex-wrap sm:space-y-0 items-center justify-between">
        ...
        <div>
            @can('karyawan_sertifikasi.create')
            ...
            @else
                <div class="text-sm text-gray-500 italic">No permission to create Sertifikasi</div>
            @endcan
        </div>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex justify-end gap-2">
                                    ...
                                    @endcan
                                    @can('karyawan_sertifikasi.delete')
